...
public class TestTransito {

	@Test
	public void queSePuedaCrearUnAuto() {
		Auto nuevo = new Auto("JJZ526", 5, 240, 41.40338, 2.17403);
		assertEquals("JJZ526", nuevo.getPatente());
		assertEquals((Integer)5, nuevo.getCapacidadMaximaDePasajeros());
		assertEquals((Integer)240, nuevo.getVelMax());
	...
	public void queSePuedaCrearUnaMoto() {
		...
		assertEquals((Integer) 2, nuevo.getCAPACIDA_MAXIMA_PASAJEROS());
